...
#define ATSqlitePath [NSString stringWithFormat:@"%@/userData/%@/data.sqlite",ATDocumentPath,@"YCMemory"]
...
//}
//-(ATFriendInfoModel *)isFriendWithName:(NSString *)name
//{
//    NSString *where = [NSString stringWithFormat:@"where imToken = '%@'",name];
//    NSArray *arr = [[ATFMDBTool shareDatabase] at_lookupTable:@"friendList" dicOrModel:[ATFriendInfoModel new] whereFormat:where];
//    if (arr.count>0) {
//        return [arr firstObject];
//    }else
//        return nil;
